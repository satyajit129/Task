...
@section('content')
    <form action="{{ route('user.dashboard.update', $application->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('POST')
                                    ...
                                    <div class="nftmax-ptabs__sauthor">
                                        <div class="nftmax-ptabs__sauthor-img nftmax-ptabs__pthumb"
                                            ...
                                            <img id="preview-image"
                                                src="{{ asset('storage/images/' . $application->photo) }}" alt="Profile">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input @error('name') is-invalid @enderror"
                            value="{{ old('name', $application->name) }}" type="text" name="name"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" value="{{ old('mother_name', $application->mother_name) }}"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('father_name', $application->father_name) }}" name="father_name"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" value="{{ old('spouse_name', $application->spouse_name) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input"
                            value="{{ old('present_village_name', $application->present_village_name) }}" type="text"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('present_zone', $application->present_zone) }}" name="present_zone"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('present_zone', $application->present_zone) }}" name="present_ward_no"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('present_post_office', $application->present_post_office) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="number"
                            value="{{ old('present_post_code', $application->present_post_code) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('present_upazila', $application->present_upazila) }}" name="present_upazila"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('present_district', $application->present_district) }}" name="present_district"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('present_country', $application->present_country) }}" name="present_country"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">(Village/Road/Holding-No:)</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('permanent_village', $application->permanent_village) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Zone</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('permanent_zone', $application->permanent_zone) }}" name="permanent_zone"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Ward No</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('permanent_ward', $application->permanent_ward) }}" name="permanent_ward"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Post Office</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('permanent_post_office', $application->permanent_post_office) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Post Code</label>
                        <input class="nftmax__item-input" type="number"
                            value="{{ old('permanent_post_code', $application->permanent_post_code) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Upazila</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('permanent_upazila', $application->permanent_upazila) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Country</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('permanent_country', $application->permanent_country) }}"
                ...
                <div class="col-6">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('mobile_no', $application->mobile_no) }}" name="mobile_no"
                ...
                <div class="col-6">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('email_no', $application->email_no) }}" name="email_no"
                ...
                <div class="col-6">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('nationality', $application->nationality) }}" name="nationality"
                ...
                <div class="col-6">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" name="nid_no"
                            value="{{ old('nid_no', $application->nid_no) }}" type="number"
                ...
                <div class="col-6">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text" value="{{ old('bin', $application->bin) }}"
                ...
                <div class="col-6">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="text" value="{{ old('tin', $application->tin) }}"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Business
                            Name </label>
                        <input class="nftmax__item-input" value="{{ old('business_name', $application->business_name) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">(Village/Road/Holding-No:)</label>
                        <input class="nftmax__item-input"
                            value="{{ old('business_village_name', $application->business_village_name) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Zone</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('business_zone', $application->business_zone) }}" name="business_zone"
                            placeholder="Enter Your Zone">
                    </div>
                </div>
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Ward No</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('business_word', $application->business_word) }}" name="business_word"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Post Office</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('business_post_office', $application->business_post_office) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Post Code</label>
                        <input class="nftmax__item-input" type="number"
                            value="{{ old('business_post_code', $application->business_post_code) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" name="business_upazila"
                            value="{{ old('business_upazila', $application->business_upazila) }}" type="text"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">District</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('business_district', $application->business_district) }}"
                ...
                <div class="col-lg-6 col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Country</label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('business_country', $application->business_country) }}" name="business_country"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        <label class="nftmax__item-label">Business
                            Type </label>
                        <input class="nftmax__item-input" type="text"
                            value="{{ old('business_type', $application->business_type) }}" name="business_type"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="number"
                            value="{{ old('business_capital', $application->business_capital) }}" name="business_capital"
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <select class="nftmax__item-input" name="ownership">
                            ...
                            <option value="Own" {{ $application->ownership === 'Own' ? 'selected' : '' }}>Own</option>
                            <option value="Rent" {{ $application->ownership === 'Rent' ? 'selected' : '' }}>Rent</option>
                        </select>
                    </div>
                ...
                <div class="col-12">
                    <div class="nftmax__item-form--group nftmax-last-name">
                        ...
                        <input class="nftmax__item-input" type="number"
                            value="{{ old('signboard', $application->signboard) }}" name="signboard"
                ...
                <div class="attachment">
                    <div class="col-12">
                        <div class="nftmax__item-form--group nftmax-last-name">
                            ...
                            <input class="nftmax__item-input" value="{{ old('birth_photo', $application->application) }}"
